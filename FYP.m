...
parfor parallel = 8:maxParallel
    sensD = ceil(parallel/10)*0.1;
    ...
    maxWorker = 10;
    param = [0.000 -2.1 4.42 1.3 0.81 0.55];
    ...
    while(1)
        for worker = 3:maxWorker
            ...
            if worker > 9 || prevResult == minReward
                newParam(worker,:) = [0,(randi(801,1,1)-801)*0.01,(randi(801,1,2)-1)*0.01,0,0];
